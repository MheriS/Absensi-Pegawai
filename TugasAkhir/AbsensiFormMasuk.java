 ...
 * @author herib
 */
public class AbsensiFormMasuk extends javax.swing.JFrame {
    int xMouse;
    int yMouse;
    String a,b,c;

    /**
     * Creates new form AbFromMasuk
     */
    public AbsensiFormMasuk() {
        initComponents();
        jam();
        tanggal();
    ...
    public void jam(){
        ActionListener taskPerformer = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                jLabel_waktu.setText(jam + ":" + menit + ":" + detik + "");
            }
        };
    ...
    private void initComponents() {
        ...
        Submit.setBounds(140, 380, 100, 25);
        ...
        gerak.setText("                    Silahkan, segera melakukan absensi...!!!");

        javax.swing.GroupLayout jPanel2Layout = new javax.swing.GroupLayout(jPanel2);
        jPanel2.setLayout(jPanel2Layout);
        jPanel2Layout.setHorizontalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(gerak, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanel2Layout.setVerticalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(gerak, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
        );
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        AbsensiMasuk a = new AbsensiMasuk(jLabel_waktu.getText(), abjampulang.getText(), jLabel_tanggal1.getText(), abNIP.getText(), abnama.getText(), abjabatan.getText());
        ...
        AbsensiMasuk b = new AbsensiMasuk();
        String muncul = b.getP();

        String nip = abNIP.getText();
        try{
            String sql = "SELECT `Nama`, `Jabatan` FROM `create` where NIP = '"+nip+"';";
        ...
        if(abNIP.getText().equals("")){
            ...
            try{
                String sql = " INSERT INTO attendance VALUES('"+ nip1 + "','" + nama + "','" + jabatan + "','" + masuk + "','" + pulang + "','" + date + "')";
                java.sql.Connection conn = (Connection) AbsensiPegawai.getConnection();
                java.sql.PreparedStatement pstm = conn.prepareStatement(sql);
                pstm.execute();
    ...
    private void jButton1CariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1CariActionPerformed
        AbsensiMasuk a = new AbsensiMasuk();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbsensiFormMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbsensiFormMasuk().setVisible(true);
            }
        });
    }
